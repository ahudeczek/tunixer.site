...
$get_all_rock_songs = "SELECT tx_songs.song_name, tx_songs.mp3, tx_songs.img, tg.name FROM tx_songs JOIN tx_groups tg on tg.ID_group = tx_songs.ID_group WHERE tx_songs.ID_g LIKE 5";
$result = mysqli_query($db, $get_all_rock_songs);
$songs = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
<body class="index-body">
<div class="dashboard-user">
    <p><a href="dashboard"><?php echo $_SESSION["username"] ?></a></p>
</div>
...
<h1 class="songs-heading">Blues</h1>
<main>
    ...
    foreach ( $songs as $song) {
        ...
        echo "<p>".$song["name"]."</p>";
        $audio_id = 'audio'.$counter;
        echo "<audio id=$audio_id class=$audio_id controls preload='none'>"."<source src=$sound type='audio/mpeg'>"."</audio>";
        echo "</div>";
        $counter++;
    }
    ?>
