...
$get_all_rock_songs = "SELECT tx_songs.song_name, tx_songs.mp3, tx_songs.img, tg.name FROM tx_songs JOIN tx_groups tg on tg.ID_group = tx_songs.ID_group WHERE tx_songs.ID_g LIKE 2";
